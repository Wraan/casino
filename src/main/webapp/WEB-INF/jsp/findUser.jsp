			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="row placeholders centered2">
					<div class="col-xs-6 col-sm-3 placeholder">
						<form:form method="POST" action="/findUser" class="navbar-form navbar-right">
							<div class="form-group">
								<input placeholder="Enter user's login to find" class="form-control" name="userFindLogin" autofocus />
							</div>
							<input value="Find User" type="submit" class="btn btn-success"/>
						</form:form>
					</div>
				</div>
			</div>
